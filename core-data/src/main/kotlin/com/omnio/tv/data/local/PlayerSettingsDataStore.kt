...
data class SubtitleStyleSettings(
    ...
    val textColor: Int = ARGB_WHITE,
    val backgroundColor: Int = ARGB_TRANSPARENT,
    val outlineEnabled: Boolean = true,
    val outlineColor: Int = ARGB_BLACK,
        ...
        factory.get(pid, FEATURE).data.map { prefs ->
            PlayerSettings(
                ...
                subtitleStyle = SubtitleStyleSettings(
                    ...
                    textColor = prefs[subtitleTextColorKey] ?: ARGB_WHITE,
                    backgroundColor = prefs[subtitleBackgroundColorKey] ?: ARGB_TRANSPARENT,
                    outlineEnabled = prefs[subtitleOutlineEnabledKey] ?: true,
                    outlineColor = prefs[subtitleOutlineColorKey] ?: ARGB_BLACK,
