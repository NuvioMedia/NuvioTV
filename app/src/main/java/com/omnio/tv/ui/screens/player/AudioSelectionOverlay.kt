...
private fun AudioTrackCard(
    ...
    Card(
        ...
        colors = CardDefaults.colors(
            containerColor = if (isSelected) OmnioColors.Secondary else Color.Transparent,
            focusedContainerColor = if (isSelected) OmnioColors.Secondary else Color.Transparent
        ),
        ...
        val primaryTextColor = if (isSelected) OmnioColors.OnSecondary else Color.White
        val secondaryTextColor = if (isSelected) {
            OmnioColors.OnSecondary.copy(alpha = 0.82f)
        } else {
...
private fun AudioMixContent(
    ...
    Column(
        ...
        Card(
            ...
            colors = CardDefaults.colors(
                containerColor = if (persistAmplification) OmnioColors.Secondary else Color.Transparent,
                focusedContainerColor = if (persistAmplification) OmnioColors.Secondary else Color.Transparent
            ),
            shape = CardDefaults.shape(RoundedCornerShape(12.dp)),
            border = CardDefaults.border(
                border = Border(
            ...
            Text(
                ...
                color = if (persistAmplification) OmnioColors.OnSecondary else Color.White,
...
private fun MixStepCard(
    ...
    Card(
        ...
        border = CardDefaults.border(
            ...
            focusedBorder = Border(
                border = BorderStroke(2.dp, if (enabled) OmnioColors.FocusRing else Color.Transparent),
                shape = RoundedCornerShape(12.dp)
            )
        ),
        scale = CardDefaults.scale(focusedScale = 1f, pressedScale = 1f)
