...
fun TraktScreen(
    ...
    val strWatchProgressNuvio = stringResource(R.string.trakt_watch_progress_source_omnio)
    ...
    Row(
        ...
        Column(
            modifier = Modifier
                ...
                .background(OmnioColors.BackgroundElevated.copy(alpha = 0.35f), RoundedCornerShape(18.dp))
                .padding(20.dp)
        ) {
            ...
            Column(
                ...
                if (uiState.mode == TraktConnectionMode.AWAITING_APPROVAL) {
                    ...
                    Button(
                        ...
                        modifier = Modifier.focusRequester(primaryFocusRequester),
                        colors = ButtonDefaults.colors(
                            containerColor = OmnioColors.Primary,
        ...
        OmnioDialog(
            ...
            Column(verticalArrangement = Arrangement.spacedBy(12.dp)) {
                ...
                Button(
                    ...
                    Text(stringResource(R.string.trakt_watch_progress_source_omnio))
                }
                Row(
                    modifier = Modifier.fillMaxWidth(),
                    ...
                    Row(
                        ...
                        rowOptions.forEach { days ->
                            ...
                            Button(
                                ...
                                colors = ButtonDefaults.colors(
                                    containerColor = if (selected) OmnioColors.Primary else OmnioColors.BackgroundCard,
                                    contentColor = if (selected) Color.Black else OmnioColors.TextPrimary
                                )
                            ) {
        ...
        OmnioDialog(
            ...
            Column(verticalArrangement = Arrangement.spacedBy(12.dp)) {
                Button(
                    ...
                    colors = ButtonDefaults.colors(
                        containerColor = if (uiState.showUnairedNextUp) OmnioColors.Primary else OmnioColors.BackgroundCard,
                        contentColor = if (uiState.showUnairedNextUp) Color.Black else OmnioColors.TextPrimary
                    ),
                    modifier = Modifier.fillMaxWidth()
                ) {
        ...
        OmnioDialog(
            ...
            Column(verticalArrangement = Arrangement.spacedBy(12.dp)) {
                Button(
                    ...
                    colors = ButtonDefaults.colors(
                        containerColor = if (uiState.showMetaComments) OmnioColors.Primary else OmnioColors.BackgroundCard,
                        contentColor = if (uiState.showMetaComments) Color.Black else OmnioColors.TextPrimary
                    ),
                    modifier = Modifier.fillMaxWidth()
                ) {
    ...
    Column(
        ...
        Box(
            modifier = Modifier
                .fillMaxWidth()
                .height(1.dp)
                .background(OmnioColors.Border.copy(alpha = 0.8f))
        )
        Row(
            modifier = Modifier.fillMaxWidth(),
            verticalAlignment = Alignment.CenterVertically
                ...
                if (index != values.lastIndex) {
                    Box(
                        modifier = Modifier
                            .width(1.dp)
                            .height(44.dp)
                            .background(OmnioColors.Border.copy(alpha = 0.75f))
                    )
                }
            }
        }
