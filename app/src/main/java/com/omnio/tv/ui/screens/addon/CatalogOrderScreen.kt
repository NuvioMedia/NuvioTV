        ...
        Row(
            ...
            Column(modifier = Modifier.weight(1f)) {
                Text(
                    ...
                    color = if (item.isDisabled) OmnioColors.TextSecondary else OmnioColors.TextPrimary
                )
            ...
            Row(
                ...
                Button(
                    ...
                    colors = ButtonDefaults.colors(
                        containerColor = OmnioColors.BackgroundCard,
                        contentColor = if (item.isDisabled) OmnioColors.Success else OmnioColors.TextSecondary,
                        focusedContainerColor = OmnioColors.FocusBackground,
                        focusedContentColor = if (item.isDisabled) OmnioColors.Success else OmnioColors.Error
                    ),
                    border = ButtonDefaults.border(
                        focusedBorder = Border(
                            border = BorderStroke(2.dp, OmnioColors.FocusRing),
