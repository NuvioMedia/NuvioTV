        ...
        when (playerSettings.nextEpisodeThresholdMode) {
            NextEpisodeThresholdMode.PERCENTAGE -> {
                SliderSettingsItem(
                    ...
                    valueText = if (playerSettings.nextEpisodeThresholdPercent <= 0f) stringResource(R.string.action_never) else "${formatHalfStepValue(playerSettings.nextEpisodeThresholdPercent)}%",
                    minValue = 0,
                    maxValue = 199,
                    step = 1,
            ...
            NextEpisodeThresholdMode.MINUTES_BEFORE_END -> {
                SliderSettingsItem(
                    ...
                    valueText = if (playerSettings.nextEpisodeThresholdMinutesBeforeEnd <= 0f) stringResource(R.string.action_never) else "${formatHalfStepValue(playerSettings.nextEpisodeThresholdMinutesBeforeEnd)} min",
                    minValue = 0,
                    maxValue = 7,
                    step = 1,
