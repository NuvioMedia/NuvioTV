                        ...
                        if (mode == importMode) {
                            Button(
                                ...
                                colors = ButtonDefaults.colors(
                                    ...
                                    contentColor = OmnioColors.Background,
                                    focusedContainerColor = OmnioColors.Primary,
                                    focusedContentColor = OmnioColors.Background
                                ),
                                border = ButtonDefaults.border(
                                    focusedBorder = Border(
                                        border = BorderStroke(2.dp, OmnioColors.FocusRing),
            ...
            item {
                when (importMode) {
                    ImportMode.PASTE -> {
                        ...
                        Surface(
                            shape = RoundedCornerShape(12.dp),
                            colors = SurfaceDefaults.colors(containerColor = OmnioColors.BackgroundElevated),
                            border = Border(
                                border = BorderStroke(1.dp, if (importError != null) OmnioColors.Error else OmnioColors.Border),
                                shape = RoundedCornerShape(12.dp)
                            ),
                            modifier = Modifier
                                .fillMaxWidth()
                            ...
                            Box(modifier = Modifier.padding(12.dp)) {
                                BasicTextField(
                                    ...
                                    cursorBrush = SolidColor(OmnioColors.Primary),
            ...
            if (validationResult != null && validationResult.valid) {
                item {
                    ...
                    Surface(
                        ...
                        border = Border(
                            border = BorderStroke(1.dp, OmnioColors.Primary),
                            shape = RoundedCornerShape(12.dp)
                        ),
                        modifier = Modifier.fillMaxWidth()
                    ) {
