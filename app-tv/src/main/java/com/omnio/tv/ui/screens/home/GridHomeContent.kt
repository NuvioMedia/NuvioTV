...
import com.omnio.tv.ui.components.GridContinueWatchingSection
import com.omnio.tv.ui.components.HeroCarousel
...
fun GridHomeContent(
    ...
    onItemFocus: (com.omnio.tv.domain.model.MetaPreview) -> Unit = {},
...
private fun StickyCategoryHeader(
    ...
    val bgColor = OmnioColors.Background
