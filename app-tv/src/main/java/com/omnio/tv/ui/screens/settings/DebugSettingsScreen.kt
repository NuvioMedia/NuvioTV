...
private fun DebugDialogButton(
    ...
    Card(
        ...
        Text(
            text = text,
            style = MaterialTheme.typography.bodyMedium,
            color = if (isFocused) OmnioColors.TextPrimary else OmnioColors.TextSecondary,
            modifier = Modifier
                .fillMaxWidth()
    ...
    Column(
        ...
        if (result != null) {
            Text(
                text = result,
                style = MaterialTheme.typography.bodySmall,
                color = if (result.startsWith("Failed")) OmnioColors.Error else OmnioColors.Secondary
            )
        }
