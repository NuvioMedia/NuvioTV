                    ...
                    Card(
                        ...
                        Row(
                            ...
                            Column(modifier = Modifier.weight(1f)) {
                                Text(
                                    text = title,
                                    color = if (isSelected || isFocused) OmnioColors.Primary else OmnioColors.TextPrimary,
                                    style = MaterialTheme.typography.bodyLarge
                                )
                                Spacer(modifier = Modifier.height(4.dp))
                                Text(
    ...
    OmnioDialog(
        ...
        Column(
            ...
            Card(
                ...
                colors = CardDefaults.colors(
                    containerColor = if (selected.isEmpty()) OmnioColors.FocusBackground else OmnioColors.BackgroundCard,
                    focusedContainerColor = OmnioColors.FocusBackground
                ),
                shape = CardDefaults.shape(shape = androidx.compose.foundation.shape.RoundedCornerShape(10.dp)),
                scale = CardDefaults.scale(focusedScale = 1f)
                ...
                Row(
                    ...
                    Text(
                        text = allLabel,
                        color = if (selected.isEmpty()) OmnioColors.Primary else OmnioColors.TextPrimary,
                        style = MaterialTheme.typography.bodyLarge,
                        modifier = Modifier.weight(1f)
                    )
                    if (selected.isEmpty()) {
                    ...
                    items(
                        ...
                        Card(
                            ...
                            Text(
                                ...
                                color = if (isFocused) OmnioColors.Primary else OmnioColors.TextPrimary
                            )
                        }
                    }
                }
                ...
                Card(
                    ...
                    Box(modifier = Modifier.padding(horizontal = 14.dp, vertical = 12.dp)) {
                        BasicTextField(
                            ...
                            cursorBrush = SolidColor(if (isInputFocused) OmnioColors.Primary else Color.Transparent),
