...
import com.omnio.tv.domain.model.MDBListRatingsResult
import com.omnio.tv.domain.model.MDBListSettings
        ...
        val imdbId = resolveImdbId(
            meta = Meta(
                ...
                type = when (normalizeMediaType(itemType)) {
                    "show" -> com.omnio.tv.domain.model.ContentType.SERIES
                    else -> com.omnio.tv.domain.model.ContentType.MOVIE
                },
                name = itemId,
                poster = null,
                posterShape = com.omnio.tv.domain.model.PosterShape.POSTER,
                background = null,
                logo = null,
                description = null,
                releaseInfo = null,
