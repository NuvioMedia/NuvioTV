    ...
    fields: [
      {
        ...
        kind: "select",
        options: ["INTERNAL", "MPV", "EXTERNAL"],
      },
      {
        key: "internal_player_engine",
        label: "Internal engine",
        kind: "select",
        options: ["EXOPLAYER", "MPV"],
      },
      {
      ...
      { key: "tunneling_enabled", label: "Video tunneling", kind: "boolean" },
      {
        ...
        label: "MPV hwdec",
        kind: "select",
        options: ["auto", "auto-copy", "no", "mediacodec", "mediacodec-copy"],
      },
      ...
      { key: "frame_rate_matching", label: "Frame-rate matching", kind: "boolean" },
      {
        ...
        label: "FRM mode",
        kind: "select",
        options: ["DISABLED", "DISPLAY", "REFRESH"],
      },
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        kind: "select",
        options: ["BY_LANGUAGE", "BY_SOURCE", "FLAT"],
      },
      {
        key: "addon_subtitle_startup_mode",
        label: "Addon sub startup",
        kind: "select",
        options: ["OFF", "PREFER", "ONLY_ON_NO_EMBEDDED"],
      },
      {
    ...
    fields: [
      {
        ...
        kind: "select",
        options: ["DISABLED", "FIRST", "REGEX", "BEST_QUALITY"],
      },
      {
        key: "stream_auto_play_source",
        label: "Source filter",
        kind: "select",
        options: ["ALL", "ADDONS_ONLY", "PLUGINS_ONLY", "SELECTED"],
      },
      {
      ...
      },
      {
        ...
        kind: "select",
        options: ["PERCENT", "MINUTES_BEFORE_END"],
      },
      {
